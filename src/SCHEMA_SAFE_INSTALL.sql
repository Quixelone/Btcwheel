-- ============================================
-- SAFE USER MANAGEMENT INSTALLATION
-- ============================================
-- Questo script ignora gli errori di cleanup
-- Esegui tutto insieme in un colpo solo
-- ============================================

-- ============================================
-- CLEANUP SICURO (ignora errori)
-- ============================================
...
BEGIN
  ...
  -- Drop TABLES (questo elimina automaticamente anche policies e trigger)
  ...
  RAISE NOTICE 'Cleanup completato con successo';
END $$;
...
SELECT 
  '✅ USER MANAGEMENT INSTALLATO CON SUCCESSO!' as status,
