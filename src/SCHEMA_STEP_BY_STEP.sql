-- ============================================
-- STEP-BY-STEP USER MANAGEMENT INSTALLATION
-- ============================================
-- IMPORTANTE: Esegui UN BLOCCO ALLA VOLTA
-- Copia e incolla ogni sezione separatamente
-- ============================================


-- ============================================
-- STEP 1: CLEANUP (esegui questo per primo)
-- ============================================
...
SELECT 'CLEANUP COMPLETATO - Nessuna tabella user management presente' as status;


-- ============================================
-- STEP 2: Crea tabella USER_PROFILES
-- ============================================
...
-- Verifica creazione
SELECT 'USER_PROFILES creata con successo' as status;
SELECT * FROM user_profiles LIMIT 1;


-- ============================================
-- STEP 3: Crea tabella SUBSCRIPTION_PLANS
-- ============================================
...
-- Verifica creazione
SELECT 'SUBSCRIPTION_PLANS creata con successo' as status;
SELECT * FROM subscription_plans LIMIT 1;


-- ============================================
-- STEP 4: Crea tabella USER_SUBSCRIPTIONS
-- ============================================
...
-- Verifica creazione
SELECT 'USER_SUBSCRIPTIONS creata con successo' as status;
SELECT * FROM user_subscriptions LIMIT 1;


-- ============================================
-- STEP 5: Crea tabelle USER_BACKUPS e ADMIN_AUDIT_LOG
-- ============================================
...
-- Verifica creazione
SELECT 'USER_BACKUPS e ADMIN_AUDIT_LOG create con successo' as status;


-- ============================================
-- STEP 6: Inserisci dati iniziali (3 piani)
-- ============================================
...
SELECT 'RLS e POLICIES configurate con successo' as status;


-- ============================================
-- STEP 8: Crea FUNCTIONS e TRIGGERS
-- ============================================
...
SELECT 'FUNCTIONS e TRIGGERS creati con successo' as status;


-- ============================================
-- STEP 9: Crea VIEW per admin
-- ============================================
...
SELECT 'VIEW admin_users_overview creata con successo' as status;
