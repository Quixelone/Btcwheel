-- ============================================
-- USER MANAGEMENT SCHEMA FOR BTCWHEEL
-- ============================================
...
CREATE TABLE IF NOT EXISTS user_backups (
  ...
  -- Include: profile, subscription, strategies, trades, progress, badges
...
CREATE TABLE IF NOT EXISTS admin_audit_log (
  ...
  action TEXT NOT NULL, -- 'user_created', 'plan_changed', 'user_suspended', ecc.
  entity_type TEXT NOT NULL, -- 'user', 'subscription', 'plan', ecc.
  entity_id UUID,
...
-- ADMIN AUDIT LOG: Only readable by service role (backend)
-- No public policies - admin access only via backend
...
SELECT 
  ...
  (
    SELECT COUNT(*) 
    FROM wheel_strategies ws 
    WHERE ws.user_id = u.id
  ) as total_strategies,
  (
    SELECT COUNT(*) 
    FROM wheel_trades wt 
...
-- DONE! ✅
-- ============================================
-- Ora puoi eseguire le API backend e l'admin panel
-- Tutte le tabelle, policies, trigger e view sono pronti
-- ============================================
