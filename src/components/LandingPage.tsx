...
// Prof Satoshi mascot images - USING SVG for reliability
const profSatoshiExcited = MASCOT_FALLBACK.excited;
const profSatoshiNormal = MASCOT_FALLBACK.normal;
const profSatoshiConfident = MASCOT_FALLBACK.normal;

// btcwheel logo - USING SVG for reliability
const btcwheelLogoPng = MASCOT_FALLBACK.logo;
                ...
                >
                  ...
                  >
                    ...
                    <img 
                      ...
                      onError={(e) => {
                        console.error('❌ Error loading Landing Page Mascot:', mascotExcitedImage);
                        e.currentTarget.style.display = 'none';
                      }}
                      onLoad={() => console.log('✅ Landing Page Mascot Loaded:', mascotExcitedImage)}
                    />
